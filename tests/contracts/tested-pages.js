...
export const TESTED_PAGES = Object.freeze([
  {
    id: 'campaign-sender-ids',
    routes: ['/campaigns/sender-ids'],
    specFiles: [
      'campaign-sender-ids.authed.spec.js',
      'campaign-sender-ids.mutations.authed.spec.js',
    ],
    archetype: {
      hasData: true,
      hasCharts: false,
    ...
    naStyles: {
      '@perf': 'Grafik veya ağır içerik yok; yalnız Sender ID talepleri tablosu var.',
