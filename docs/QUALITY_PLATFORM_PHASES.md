...
- **Son güncelleme (audit):** 2026-07-30, WP-R3 (known-bug forensik mod + güvenli artifact hattı + nightly fixed-candidate önerisi merge edildi, PR #48; merge sonrası `main` üzerinde `workflow_dispatch finding_id=B4` ile güvenli/read-only forensik akış doğrulandı).
